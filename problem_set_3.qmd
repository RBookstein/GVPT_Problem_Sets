...
The sample variability is relatively high because of the randomization of the countries selected. The potential bias is not as high because the selection is random rather than five countries one one continent/region. 
...
The sample variability is high because of the amount of countries selected being 75, the randomization of their selection, and looking at a period of 25 years. The potential bias in the situation is low because the high amount of countries selected around the world as well as it being random. This bias is lower because of the random selection which will allow for counties from around the world instead of similar countries. 
...
load("~/Documents/GVPT_Problem_Sets/hanmerKalkanANES.RData")
