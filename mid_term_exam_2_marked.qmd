...
::: {.callout-tip}
You need to demonstrate that you are using the t-statistic. 
:::
...
6 times 6 = 36 There are 12 outcomes where both rolls could be odd or greater than four, thus the answer is 12/36 or 1/3 or 33.33 percent.
...
(0.874 - 0.906) +- 1.96\*0.015 -0.032 +- 0.0294 -0.0614 -0.0026
...
105 +- 1.96*(120/40) 105 +- 1.96*3 105 + 5.88 = 110.88 105 - 5.88 = 99.12
...
105-100 = 5 square root of 1600 = 40 120/40 = 3 5/3 = 1.67.
...
::: {.callout-tip}
You needed to exclude those who are ineligible to vote.
:::

::: {.callout-tip}
You did not finish calculating the chi-square statistic. 
:::
...
Voted: A Great Deal: (1215*997)/1896 = 638.9 (642-638.9)\^2/638.9 = 0.015 Only Some: (1215*755)/1896 = 483.82 (498-483.82)\^2/483.82 = 0.415 Hardly Any: (1215\*144)/1896 = 92.27 (75-92.27)\^2/92.27 = 3.232

Did not Vote: A Great Deal: (537*997)/1896 = 282.37 (278-282.37)\^2/282.37 = 0.067 Only Some: (537*755)/1896 = 213.837 (208-213.837)\^2/213.837 = 0.159 Hardly Any: (537\*144)/1896 = 40.784 (51-40.784)\^2/40.784 = 2.559

Ineligible: A Great Deal: (144*997)/1896 = 75.72 (77-75.72)\^2/75.72 = 0.0216 Only Some: (144*755)/1896 = 57.341 (49-57.341)\^2/57.341 = 1.213 Hardly Any: (144\*144)/1896 = 10.936 (18-10.936)\^2/10.936 = 4.56292
...
Here are the known values: Mean Disapprove: 3.54943 Mean Approve: 5.109453 Disapprove Standard Deviation: 1.491 Approve Standard Deviation: 1.27 Disapprove Sample Size: 1578 Approve Sample Size: 804

We can then calculate the pooled variance: sqrt(((1578-1)*(1.491\^2)+(804-1)*(1.27\^2)/(1578+804-2)) (1577*2.22)+(803*1.6129) 3500.94 + 1295.1587 4796.099/2380 sqrt of 2.015 = 1.4195

::: {.callout-tip}
This is the incorrect approach to calculating the pooled SE, but you're on the right track. 
:::

We then determine the degrees of freedom 1578+804-2 = 2380

::: {.callout-tip}
The DF is equal to the smaller of the two group sizes minus 1. 
:::

We then calculate the t-statistic: -1.560023/(1.4195)\*(sqrt(1/1578+1/804)) -0.475
...
::: {.callout-tip}
This is a difference of proportions problem, not of counts. 
:::
...
Did Note Vote: Not Important: (778*1268)/3620 = 272.5149 (297-272.5149)\^2/272.5149 = 2.199954 Somewhat Important: (778*473)/3620 = 101.6558 (106-101.6558)\^2/101.6558 = 0.1856468 Quite a Bit: (778*650)/3620 = 139.6961 (141-139.6961)\^2/139.6961 = 0.01217038 A Great Deal: (778*1229)/3620 = 264.1331 (234-264.1331)\^2/264.1331 = 3.437675

Voted: Not Important: (2842*1268)/3620 = 995.4851 (971-995.4851)\^2/995.4851 = 0.6022392 Somewhat Important: (2842*473)/3620 = 371.3442 (367-371.3442)\^2/371.3442 = 0.05082097 Quite a Bit: (2842*650)/3620 = 510.3039 (509-510.3039)\^2/510.3039 = 0.003331652 A Great Deal: (2842*1229)/3620 = 964.8669 (995-964.8669)\^2/964.8669 = 0.9410663
