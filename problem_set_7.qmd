...
|                 |                |                |                |                |
|                 | chisq=(0.0181) | chisq=(0.5765) | chisq=(1.0667) |                |
+-----------------+----------------+----------------+----------------+----------------+
...
21-35
Not at All: (11*12)/40 = 3.3 (5-3.3)^2/3.3 = 0.875
Somewhat: (17*12)/40 = 5.1 (6-5.1)^2/5.1 = 0.159
Very Much: (12*12)/40 = 3.6 (1-3.6)^2/3.6 = 1.87

36-50
Not at All: (11*9)/40 = 2.48 (1-2.48)^2/2.48 = 0.88
Somewhat: (17*9)/40 = 3.83 (5-3.83)^2/3.83 = 0.36
Very Much: (12*9)/40 = 2.7 (3-2.7)^2/2.7 = 0.03

51-65
Not at All: (11*8)/40 = 2.2 (2-2.2)^2/2.2 = 0.018
Somewhat: (17*8)/40 = 3.4 (2-3.4)^2/3.4 = 0.576
Very Much: (12*8)/40 = 2.4 (4-2.4)^2/2.4 = 1.066667

66+
Not at All: (11*11)/40 = 3.025 (3-3.025)^2/3.025 = 0.0002
Somewhat: (17*11)/40 = 4.675 (4-4.675)^2/4.675 = 0.0974
Very Much: (12*11)/40 = 3.3 (4-3.3)^2/3.3 = 0.1484
...
Based on the data seen above, the chi-square statistic is 40.105 with a p-value of 0.00000000118 at a 95% confidence interval. Based on this information, the null hypothesis of association between liberal/conservative identification and gun access can be rejected. There is no significant relationship between the variables, the 95% confidence interval with an extremely low p-value. As seen in the data above the original can be rejected, as 37 percent of liberals believe gun control is more important compared to 33 percent supporting the claim of gun control being more important. This finding rejects the original hypothesis that people who identify as liberal are less likely to support gun control as an important issue when compared to those with a conservative identification. 